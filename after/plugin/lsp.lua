...
local on_attach = function(client, bufnr)
    ...
    vim.keymap.set('n', '<space>qf', vim.diagnostic
                       .setqflist({}, 'r',
                                  {title = 'Diagnostics', severity_sort = true}))
...
lspconfig['solidity_ls_nomicfoundation'].setup {
    on_attach = on_attach,
    root_dir = lspconfig.util.root_pattern('foundry.toml', 'package.json',
                                           'yarn.lock'),
    diagnostics = {enable = true},
    flags = lsp_flags
}
...
lspconfig['graphql'].setup {
    on_attach = on_attach,
    root_dir = lspconfig.util.root_pattern('schema.graphql', 'tsconfig.json',
                                           'turbo.json'),
...
lspconfig['rust_analyzer'].setup {
    on_attach = on_attach,
    root_dir = lspconfig.util.root_pattern('Cargo.toml', 'Cargo.lock',
                                           'main.rs', 'lib.rs'),
    diagnostics = {enable = true},
